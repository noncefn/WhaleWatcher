...
module.exports = async (req, res) => {
  try {
    ...
    const addressData = await getOurAddress()
    const editedAddress = checkTxs(block, addressData, db, batch)
    await setBlocks(data.time, batch)
...
async function setBlocks(blockTime, batch) {
